...
class DatabaseManager:
    ...
    def add_usage_record(self, timestamp: datetime, consumption_kwh: float, 
                        device_type: Optional[str] = None, device_name: Optional[str] = None, cost_usd: Optional[float] = None):
    ...
    def add_generation_record(self, timestamp: datetime, generation_kwh: float,
                            weather_condition: Optional[str] = None, temperature_c: Optional[float] = None,
